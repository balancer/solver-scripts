...
# Independent Liquidity Testing Setup Script for CoW Protocol with Balancer Solver - POLYGON
...
NODE_URL="https://polygon-rpc.com"  # Polygon RPC
ORDERBOOK_URL="https://barn.api.cow.fi/polygon"  # Polygon orderbook
DRIVER_PORT="11088"
LIQUIDITY_DRIVER_PORT="8080"  # Liquidity-driver port
SOLVER_PORT="8083"  # Different port to avoid conflicts
CHAIN_NAME="polygon"

echo "🚀 Setting up CoW Protocol Independent Liquidity Testing - POLYGON"
echo "=========================================================="
echo "Chain: $CHAIN_NAME (Chain ID: 137)"
...
# Setup polygon configuration
echo "🔧 Setting up polygon configuration..."
ln -sf configs/polygon/driver.toml driver.config.toml
ln -sf configs/polygon/baseline.toml baseline.config.toml
ln -sf configs/polygon/liquidity-driver.toml liquidity-driver.config.toml

echo "✅ Polygon configuration loaded"
...
echo ""
echo "✅ All services started successfully for POLYGON INDEPENDENT LIQUIDITY TESTING!"
echo ""
echo "📊 Service Status:"
echo "   - Chain: $CHAIN_NAME (Chain ID: 137)"
...
echo "     -d '{\"auctionId\":123,\"tokens\":[],\"tokenPairs\":[[\"0x0d50...\",\"0x2791...\"]],\"blockNumber\":18000000,\"protocols\":[\"balancer_v2\"]}'"
echo ""
