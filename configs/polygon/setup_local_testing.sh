...
# Local Testing Setup Script for CoW Protocol with Balancer Solver - POLYGON
# This script sets up and runs the autopilot, driver, and balancer solver for Polygon

set -e

# Configuration for Polygon
NODE_URL="https://polygon-rpc.com"  # Replace with your Polygon RPC
ORDERBOOK_URL="https://barn.api.cow.fi/polygon"  # Staging Polygon orderbook
DRIVER_PORT="11088"
SOLVER_PORT="8084"
CHAIN_NAME="polygon"

echo "🚀 Setting up CoW Protocol Local Testing Environment - POLYGON"
echo "============================================================="
...
echo ""
echo "✅ All services started successfully for POLYGON!"
echo ""
echo "📊 Service Status:"
echo "   - Chain: $CHAIN_NAME"
