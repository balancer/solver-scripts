...
# Shadow Competition Script for Balancer Solver - MAINNET
# This script runs only the balancer solver for CoW Protocol shadow competition on Ethereum Mainnet

set -e

# Configuration for Mainnet Shadow Competition
SOLVER_PORT="8100"
...
echo "🏆 Starting Balancer Solver for Shadow Competition - MAINNET"
echo "=========================================================="
...
echo ""
echo "🚀 Starting balancer solver for mainnet shadow competition..."
...
echo ""
echo "✅ Balancer solver started successfully for MAINNET shadow competition!"
echo ""
...
echo "   Mainnet Endpoint: http://YOUR_PUBLIC_IP:$SOLVER_PORT"
echo "   Chain: mainnet (Chain ID: 1)"
echo ""
