...
# Local Testing Setup Script for CoW Protocol with Balancer Solver - MAINNET
# This script sets up and runs the autopilot, driver, and balancer solver for Ethereum Mainnet
...
echo "🚀 Setting up CoW Protocol Local Testing Environment with Balancer Solver - MAINNET"
echo "============================================================="
...
echo ""
echo "✅ All services started successfully for MAINNET!"
echo ""
echo "📊 Service Status:"
echo "   - Chain: $CHAIN_NAME"
