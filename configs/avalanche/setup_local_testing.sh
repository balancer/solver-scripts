...
# Local Testing Setup Script for CoW Protocol with Balancer Solver - AVALANCHE
# This script sets up and runs the autopilot, driver, and balancer solver for Avalanche

set -e

# Configuration for Avalanche
NODE_URL="https://api.avax.network/ext/bc/C/rpc"  # Replace with your Avalanche RPC
ORDERBOOK_URL="https://barn.api.cow.fi/avalanche"  # Staging Avalanche orderbook
DRIVER_PORT="11088"
SOLVER_PORT="8085"
CHAIN_NAME="avalanche"

echo "🚀 Setting up CoW Protocol Local Testing Environment - AVALANCHE"
echo "==============================================================="
...
echo ""
echo "✅ All services started successfully for AVALANCHE!"
echo ""
echo "📊 Service Status:"
echo "   - Chain: $CHAIN_NAME"
