...
# Independent Liquidity Testing Setup Script for CoW Protocol with Balancer Solver - BASE
...
NODE_URL="https://mainnet.base.org"  # Base RPC
ORDERBOOK_URL="https://barn.api.cow.fi/base"  # Base orderbook
DRIVER_PORT="11088"
LIQUIDITY_DRIVER_PORT="8080"  # Liquidity-driver port
SOLVER_PORT="8083"  # Different port to avoid conflicts
CHAIN_NAME="base"

echo "🚀 Setting up CoW Protocol Independent Liquidity Testing - BASE"
echo "======================================================="
echo "Chain: $CHAIN_NAME (Chain ID: 8453)"
...
ln -sf configs/base/liquidity-driver.toml liquidity-driver.config.toml
...
echo ""
echo "✅ All services started successfully for BASE INDEPENDENT LIQUIDITY TESTING!"
echo ""
echo "📊 Service Status:"
echo "   - Chain: $CHAIN_NAME (Chain ID: 8453)"
...
echo "     -d '{\"auctionId\":123,\"tokens\":[],\"tokenPairs\":[[\"0x4200...\",\"0x833...\"]],\"blockNumber\":18000000,\"protocols\":[\"balancer_v2\"]}'"
echo ""
